...
function burger(burgerSelector, menuSelector) {
  var headerBurger = document.querySelector(burgerSelector);
  var headerMenu = document.querySelector(menuSelector);
...
$(document).ready(function () {
  var sliderSpeed = 500; // $('.item-services').click(function (event) {
